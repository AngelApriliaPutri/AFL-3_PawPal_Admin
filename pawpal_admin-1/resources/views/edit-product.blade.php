            ...
            <div class="row">
                <div class="col-lg-6 col-sm-12 col-xs-12 mb-lm-30px mb-md-30px mb-sm-30px">
                    ...
                    <div class="swiper-container zoom-top">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide zoom-image-hover">
                                <img class="img-responsive m-auto" src="{{asset('storage/p0010.png')}}"
                                    alt="">
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-sm-12 col-xs-12" data-aos="fade-up" data-aos-delay="200">
                    <div class="product-details-content quickview-content">
                        <h3>Product Name</h3>
                        <input type="text" id="productName" name="productName" value="Pedigree Adult Lamb & Vegetables">
                        <br>
                        <div class="category">
                            <div class="prodCat">
                        ...
                        <div class="edit-desc">
                            <h3>Description</h3>
                            <textarea id="editDesc" name="editDesc" rows="4" cols="50" >Complete pet food for adult dogs. At PEDIGREE® we believe that every dog deserves a loving home, and that every dog deserves leading nutrition. From over 40 years' experience, we believe that dogs have four universal needs: Skin &amp; Coat, Immune system, Digestion and Dental Care. That's why the dry bags of PEDIGREE® VITAL PROTECTION are designed to deliver nutrition that addresses these four needs: the products help support a strong immune system, healthy skin and coat, good digestion, and also help to clean your dog's teeth.</textarea>
                        </div>
                        ...
                        <div class="pro-details-size-info d-flex align-items-center">
                            ...
                            <div class="pro-details-size">
                                <ul>
                                    <li><a class="active-size gray" href="#">1.5kg</a></li>
                                    <li><a class="gray" href="#">3kg</a></li>
                                    <li><a class="gray" href="#">10kg</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="pricing-meta">
                            <h3>Price</h3>
                            <input type="text" id="productPrice" name="productPrice" value="76000">
                        </div>
                        <h4 class="editStock">Edit Stock</h4>
                        <div class="pro-details-quality">
                            <div class="cart-plus-minus">
                                <input class="cart-plus-minus-box" type="text" name="qtybutton" value="8" />
                            </div>
                            <br>
                            <br>
